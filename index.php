...
<head>
    ...
    <link href='style/Main Stylesheet.css' rel='stylesheet' type='text/css'>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2? family=Architekten+Tochter&display=swap" rel="stylesheet">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    ...
    <title>RhinoJuice Website</title>
</head>
  <body>
      <nav>
        <div class="logo">         
          <svg viewBox="0 0 1411 267" fill="none" xmlns="http://www.w3.org/2000/svg">
           <a href="#top" xlink:title="I take you to the top!">
          ...
          <ul class="nav-links">
           <li>
             <a href="#product-overview">Products</a>
            </li>
           <li>
      ...
      <div class="page-content" id="top">
        ...
        <div class="product-overview" id="product-overview">
          <section class="Apple" id="apple">
            <div class="card" tabindex="0">
              <div class="cardFront">
                <img src="img/Elopak.png" alt="Product">
                <h1>Apple</h1>
        ...
        <div class="transition">
          <video autoplay muted controls src="img/Kunst_Werbung.mp4" alt="Marketing Video" ></video>
        </div>
        <div class="pac">
        ...
        <div class="production" id="production">
          ...
          <div class="text">
            <p>In der Produktion verwenden wir bevorzugt Früchte, welche aus kosmetischen Gründen entsorgt 
              werden sollten. Zudem verarbeiten wir auch gerne Früchte aus anderen Quellen, welche 
              unserem Unternehmensmotto "regional und Nachhaltig" entsprechen. <br><br>

              Um den Saft zu gewinnen, machen wir Gebrauch von Dampfentsaftern und 
              zudem verzichten wir vollkommen auf Zusatzstoffe aller Art. Den so gewonnenen Saft füllen wir in Glasflaschen ab 
              und befestigen auf diesen, mithilfe von umweltschonenden Klebern, nachhaltige Etiketten. 
              Wir können mit gutem Gewissen behaupten, dass unser Produktions- und Verpackungsweg äußerst 
              umweltfreundlich und nachaltig ist.</p>
          </div>
        </div>
        ...
        <div class="about" id="about">
          ...
          <div class="text">
            <p>RhinoJuice ist ein Schülerunternehmen bestehend aus sechs Schülern des F. F. Runge-Gymnasiums.<br><br>

              Unser Unternehmen setzt es sich zum Ziel, nachhaltige und gesunde Säfte ohne 
              Zusatzstoffe aus „unschönen“ Früchten zu produzieren, welche aus kosmetischen Gründen zur 
              Entsorgung vorgesehen waren. Weiterhin nutzen wir umweltschonende Materialien in der 
              Produktion. So verwenden wir etwa Glasflaschen und nachhaltige Kleber.
              Am wichtigsten ist uns jedoch aktiver Naturschutz. Aus diesem Grund spendet unser Unternehmen 
              20% des Reingewinns an den Nashornschutz des WWF.</p>
          </div>
          <img src="img/We.jpeg" alt="Our Team" id="We_img">
        </div>
        ...
        <div class="contact" id="contact">
          ...
          <div class="text">
            <p>Schick uns eine E-Mail mit deinem Feedback!</p>
          </div>
          <div class="Feedback">
        ...
        <div class="bottom">
          ...
          <p>This website was developed by Lél Priller. 
            I spent about 60 hours building this webpage, and I learned a lot! 
            I hope that you'll enjoy it, and of course also our RhinoJuice!</p> 
        </div>
      </div>
  </body>
</html>